...
export const FacebookTab: React.FC<FacebookTabProps> = ({ pack, onPackUpdated }) => {
  ...
  const [imageModalTab, setImageModalTab] = useState<'generate' | 'upload' | 'references'>('generate');
            ...
            <div className="flex flex-wrap items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-1.5 flex-wrap">
                ...
                >
                  ...
                  <span>Tạo bằng AI (Google Flow • Model & Tỷ lệ)</span>
                </button>

                <button
                  type="button"
                  onClick={() => {
                    setImageModalTab('references');
                    setShowAssetModal(true);
                  }}
