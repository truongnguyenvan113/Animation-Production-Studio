...
export const ReferenceCardPreview: React.FC<ReferenceCardPreviewProps> = ({
  ...
  return (
    <div
      className={`relative w-full h-48 rounded-xl bg-slate-950/80 border border-slate-800 overflow-hidden flex items-center justify-center p-3 group select-none ${className}`}
    >
      ...
      {/* Main visual demonstration based on reference type */}
